...
if (!$adminCheck->isAdmin()) {
	header('location: ../login.php');
	  ...
	  $connection = new DBConnection();
		$department = new DepartmentPost();
		$department->fetchPostID();
?>
<!DOCTYPE html>
<html>
...
<div class="header">
    ...
    <div class="maincontainer">
        <h1 style="text-align: center">Edit Department Post</h1>
        <div style="margin: 0 auto; width: 80%;">
					<form action="<?php $department->editDepartment();?>" method="post">
						<label for='title'>Enter your title:</label><br>

					<input type='text' name='title' value="<?php echo $department->post['title']; ?>" placeholder='Enter your title...' >
						<label for='entertext'>Enter your text:</label>
						<textarea placeholder='Enter your text...' name='entertext' ><?php echo  $department->post['entertext']; ?></textarea>
